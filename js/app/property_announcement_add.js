define(['mui', 'mall'], function(mui, $) {
	...
	mui.plusReady(function() {
		console.log('#property_announcement_add plusReady()')
		...
		mui.back = function() {
			pickerBlur();
			clearFeedbackInput();
			var propertySubView = plus.webview.getWebviewById('property_announcement_sub.html');
