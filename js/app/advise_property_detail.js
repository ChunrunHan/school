define(['mui', 'mall'], function(mui, $) {
	mui.init({
		...
		beforeback: function() {
			...
			var adviseSubView = plus.webview.getWebviewById('advise_property_sub.html');
			mui.fire(adviseSubView, 'adviseRefresh');
			return true;
		}
	});
	...
	mui.plusReady(function() {
		console.log('advise_property_detail plusReady()');
