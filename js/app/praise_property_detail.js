define(['mui', 'mall'], function(mui, $) {
	mui.init({
		...
		beforeback: function() {
			...
			var praiseSubView = plus.webview.getWebviewById('praise_property_sub.html');
			mui.fire(praiseSubView, 'praiseRefresh');
			return true;
		}
	});
	...
	var old_back = mui.back;
		mui.plusReady(function() {
			console.log('praise_property_detail plusReady()');
